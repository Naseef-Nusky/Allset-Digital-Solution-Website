...
export function StarIcon({ className = 'h-5 w-5', filled = true }) {
  return (
...
export function IndustryIcon({ type = 'wrench', className = 'h-5 w-5' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      {industryIcons[type] || industryIcons.wrench}
    </svg>
  )
}

export function FeatureIcon({ name, className = 'h-6 w-6' }) {
  const icons = {
    ...
    focus: <><circle cx="12" cy="12" r="3" /><path d="M12 2v3M12 19v3M2 12h3M19 12h3M4.93 4.93l2.12 2.12M16.95 16.95l2.12 2.12M4.93 19.07l2.12-2.12M16.95 7.05l2.12-2.12" /></>,
    megaphone: <><path d="M3 11v2a4 4 0 004 4h1" /><path d="M7 9l10-4v14l-10-4V9z" /><path d="M17 8a5 5 0 010 8" /></>,
  }
